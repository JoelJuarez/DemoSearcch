...
import com.android.example.liverpool.binding.FragmentBindingAdapters
import com.android.example.liverpool.util.CountingAppExecutorsRule
import com.android.example.liverpool.util.DataBindingIdlingResourceRule
import com.android.example.liverpool.util.RecyclerViewMatcher
import com.android.example.liverpool.util.TaskExecutorWithIdlingResourceRule
import com.android.example.liverpool.util.TestUtil
import com.android.example.liverpool.util.ViewModelUtil
import com.android.example.liverpool.util.disableProgressBarAnimations
...
class SearchFragmentTest {
    ...
    private val results = MutableLiveData<Resource<List<Product>>>()
